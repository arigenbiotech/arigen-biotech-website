      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-600 max-w-3xl mx-auto">
            Discover our flagship solutions built for sustainable agriculture
            and advanced crop science.
          </p>
        </div>

        <div className="flex md:grid md:grid-cols-3 md:gap-4 overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none gap-3 px-1 py-1 md:px-0 md:py-0 scrollbar-hide">
          {products.slice(0, 3).map((product, index) => (
            <article
              key={index}
              className="min-w-[90%] sm:min-w-[45%] md:min-w-0 md:static bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden snap-center"
            >
